    ...
    <div class="template-playground">
      <div class="template-playground-header">
        ...
        <div class="template-playground-status">
          @if (sessionId) {
            <span class="session-info">Session: {{ sessionId.substring(0, 8) }}...</span>
          }
          @if (saving) {
            <span class="saving-indicator">Saving...</span>
          }
          @if (lastSaved) {
            <span class="last-saved">Last saved: {{ lastSaved | date: 'short' }}</span>
          }
        </div>
          ...
          <div class="template-file-list">
            ...
            <ul class="file-list">
              @for (template of templates; track trackByName($index, template)) {
                <li [class.active]="selectedFile === template" (click)="selectFile(template)">
